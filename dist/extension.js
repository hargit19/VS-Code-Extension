...
const testCaseFetcher_1 = __webpack_require__(2);
const testRunner_1 = __webpack_require__(45);
function activate(context) {
    const fetchTestCasesCommand = vscode.commands.registerCommand('cph.fetchTestCases', () => __awaiter(this, void 0, void 0, function* () {
        ...
        if (url) {
            ...
            if (problemSlugMatch) {
                ...
                yield (0, testCaseFetcher_1.fetchAllTestCasesGraphQL)(problemSlug);
            }
            else {
    ...
    const runTestCasesCommand = vscode.commands.registerCommand('cph.runTestCases', () => __awaiter(this, void 0, void 0, function* () {
        const scriptPath = yield vscode.window.showInputBox({
            prompt: 'Enter the path to your script file to test against inputs',
        });
        if (scriptPath) {
            yield (0, testRunner_1.testAllCases)(scriptPath);
        }
        else {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.fetchAllTestCasesGraphQL = fetchAllTestCasesGraphQL;
const vscode = __importStar(__webpack_require__(1));
...
const testCaseExtractor_1 = __webpack_require__(44);
function fetchAllTestCasesGraphQL(problemSlug) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        `;
            ...
            if (questionData && questionData.content) {
                yield saveTestCases((0, testCaseExtractor_1.extractTestCases)(questionData.content));
            }
            else {
...
function saveTestCases(testCases) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        testCases.forEach(({ input, output }, index) => {
            ...
            vscode.window.showInformationMessage(`Test case ${index + 1} saved to ${inputFilePath} and ${outputFilePath}`);
        });
    });
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.testAllCases = testAllCases;
const vscode = __importStar(__webpack_require__(1));
const fs = __importStar(__webpack_require__(13));
const path = __importStar(__webpack_require__(9));
const codeRunner_1 = __webpack_require__(46);
function testAllCases(scriptPath) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            if (!vscode.workspace.workspaceFolders) {
            ...
            for (let i = 0; i < inputFiles.length; i++) {
                ...
                try {
                    const generatedOutput = yield (0, codeRunner_1.runUserCode)(input, scriptPath);
                    if ((0, codeRunner_1.compareOutputs)(generatedOutput, expectedOutput)) {
...
function runUserCode(input, scriptPath) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            ...
            fs.writeFileSync(inputFilePath, input, 'utf8');
            (0, child_process_1.exec)(`g++ "${scriptPath}" -o "${binaryPath}"`, (compileError, compileStdout, compileStderr) => {
                if (compileError) {
                ...
                const command = process.platform === 'win32'
                    ...
                    : `"${binaryPath}" < "${inputFilePath}" > "${outputFilePath}"`;
                (0, child_process_1.exec)(command, (execError, stdout, stderr) => {
                    if (execError) {
...
function compareOutputs(generated, expected) {
